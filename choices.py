...
def play_scene(scene):
    ...
    print(ai_functions.have_AI_describe(scene['description'], previous_scene['description']))
    ...
    user_choice = int(ai_functions.have_AI_choose(scene['choices'], user_choice)) - 1
